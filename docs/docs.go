                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.TestTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "获取成功",
                        "schema": {
                            "$ref": "#/definitions/controllers.TestTokenResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
